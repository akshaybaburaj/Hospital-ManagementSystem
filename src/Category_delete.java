 ...
 */
public class Category_delete extends javax.swing.JFrame {

    /**
     * Creates new form Category_delete
     */
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(billing, javax.swing.GroupLayout.PREFERRED_SIZE, 313, javax.swing.GroupLayout.PREFERRED_SIZE))
    ...
    private void billingMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_billingMouseClicked
        Billing_remove bgr = new Billing_remove();
        bgr.setVisible(true);// TODO add your handling code here:
    ...
    private void doctorMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_doctorMouseClicked
        Doctor_remove drr=new Doctor_remove();
        drr.setVisible(true);
    ...
    Patient_remove pr=new Patient_remove();
    pr.setVisible(true);
    ...
    private void nurseMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_nurseMouseClicked
        Nurse_remove nsr=new Nurse_remove();
        nsr.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Category_delete.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Category_delete().setVisible(true);
            }
        });
    }
